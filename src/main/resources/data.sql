...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (5, 'Nick', 'Green', 'nick@mail.com', '$2a$10$2s3Nd0g1IDlgVrJ759YaJuzJ3MKWRcKDjXfNjbHAYTjCgQvDiM.Zm', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (6, 'Nora', 'White', 'nora@mail.com', '$2a$10$45FI2tOMceIdHRK0BRvn9Orb5uKP8zIFAazti8k5T1Ok3DO.TCnDu', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (4, 'Mike', 'Brown', 'mike@mail.com', '$2a$10$UeTGdmpOBZcGvkd44NStfuE5jAsNhoYL1QgRHwWh1sOZVFOLVtHQu', 1);
